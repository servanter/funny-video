        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 overflow-hidden transition-all duration-500">
            {visibleTestimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-white rounded-lg shadow-md border border-gray-100 p-8 transition-all duration-300 min-h-[220px] mb-2"
              >
          ...
          {/* 指示器 - 根据可见数量计算页数 */}
          <div className="flex justify-center mt-6 gap-2 mb-3">
